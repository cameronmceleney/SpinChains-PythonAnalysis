...
class PaperFigures:
    ...
    def create_time_variation3(self, use_inset=False, interactive_plot=False):
        """
        Plot the magnetisation of a site against time.
        ...
        # ax1.plot(x1f, np.abs(y1f), marker='', lw=2.0, color='#0289F7', markerfacecolor='black',
